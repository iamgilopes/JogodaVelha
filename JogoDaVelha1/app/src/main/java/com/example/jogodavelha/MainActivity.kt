...
class MainActivity : AppCompatActivity() {
    ...
    fun buttonClick(view: View) {
        ...
        if(jogadorAtual.equals("samsung")) {
            buttonSelecionado.setBackgroundResource(R.drawable.samsung)
            jogadorAtual = "iphone"
        }else{
            buttonSelecionado.setBackgroundResource(R.drawable.iphone)
            jogadorAtual = "samsung"
        }
    ...
    fun verificaVencedor(tabuleiro: Array<Array<String>>): String? {
        ...
        for (linha in tabuleiro) {
            for (valor in linha) {
                if(valor.equals("samsung")||valor.equals("iphone")){
                    empate++
                }
            }
        }
